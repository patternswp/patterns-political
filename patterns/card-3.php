...
/**
 * Title: Card 3
 * Slug: patterns-political/card-3
 * Categories: featured
...
?>
<!-- wp:details {"showContent":true,"className":"is-style-custom-details"} -->
<details class="wp-block-details is-style-custom-details" open><summary><?php esc_html_e( 'Political organization that typically seeks', 'patterns-political' ); ?></summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block","style":{"elements":{"link":{"color":{"text":"var:preset|color|quaternary"}}}},"textColor":"quaternary"} -->
